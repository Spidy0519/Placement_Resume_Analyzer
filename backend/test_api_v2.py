...
req_data = {"session_id": session_id, "department": "CSE", "selected_job": "Software Developer", "language": "english"}
...
print("4. Getting AI analysis...")
res = requests.post(f"{base_url}/get-ai-analysis", json={"session_id": session_id, "language": "english"})
if res.status_code != 200:
    print(f"Failed to get AI analysis: {res.status_code} - {res.text}")
    sys.exit(1)
print("AI Analysis success!")
print(f"Preview: {res.json()['ai_analysis'][:200]}...")
